...
DROP INDEX IF EXISTS public.uniq_username;
DROP INDEX IF EXISTS public.uniq_role_permission;
ALTER TABLE IF EXISTS ONLY public."user" DROP CONSTRAINT IF EXISTS user_pkey;
ALTER TABLE IF EXISTS ONLY public.user_role DROP CONSTRAINT IF EXISTS uniq_user_role;
ALTER TABLE IF EXISTS ONLY public.role DROP CONSTRAINT IF EXISTS uniq_role_name;
ALTER TABLE IF EXISTS ONLY public.permission DROP CONSTRAINT IF EXISTS uniq_permission_name;
...
2	ryan	Ryan Miao	ryan@demo.com	123	2019-05-29 17:51:44.997224+08	2019-05-29 17:51:44.997224+08	2019-05-29 17:50:31+08	0	$2a$10$CXiN/3Qy.UqJlX.uBlNf4Oxf375P41ztN4nDuMaSmrKNi2Z7CUP5m
5	admin	Admin	admin@demo.com	789	2019-05-29 17:52:38.299833+08	2019-05-29 17:52:38.299833+08	2019-05-29 17:51:20+08	0	$2a$10$WGp1834JChrqL7MdhzE9BOLa89EbiqgGDnRZh/t1alaOZ9iXyudpG
4	test	Test	test@demo.com	456	2019-05-29 17:52:08.980826+08	2019-05-29 17:52:08.980826+08	2019-05-29 17:50:53+08	0	$2a$10$hf3EP6BtwgkrEg4topzv2ul65i1vNuMLin6K3QgEwHv/vsAenBgf2
\.
